            ...
            <div className='relative h-full flex items-center'>
                <div className='relative border-bottom flex items-center h-full w-full bg-[#202520]'>
                    ...
                    <div className='ml-auto px-[20px]'>
                        ...
                        <div className={`absolute w-[200px] bg-[#eee] rounded right-5 md:right-10 mt-[14.4px] md:mt-[23px] z-[-1] transition-all duration-100 ${userOptions ? 'translate-y-0 visible' : '-translate-y-full'}`}>
