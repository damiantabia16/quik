...
function ArchivedGrid({ boardId, editNote, handleUnarchiveNote, handleDeleteNote, message, setMessage }) {
...
function Archives({ boardId, message, setMessage }) {
